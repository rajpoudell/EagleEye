...
import {MdOutlineAddHome,MdLocalPolice  , MdLiveTv,MdManageAccounts ,MdAdd,MdOutlineMarkUnreadChatAlt  } from "react-icons/md";
import { FaAngleLeft } from "react-icons/fa6";
import Logo from "../../assets/Logo.png";
const Sidebar = ({ isOpen, toggleSidebar }) => {
  const navItems = [
    { name: "Dashboard", path: "/", icon: <MdOutlineAddHome className="h-5 w-5" /> },
    {
      name: "Live feeds",
      path: "/live-feeds",
      icon: <MdLiveTv className="h-5 w-5" />,
    },
    { name: "Criminals", path: "/criminals", icon: <MdManageAccounts className="h-5 w-5" /> },
    {
      name: "Add Criminal ",
      path: "/add-criminal",
    ...
    { name: "Logs", path: "/logs", icon: <MdOutlineMarkUnreadChatAlt  className="h-5 w-5" /> },
  ];
  return (
    <aside
